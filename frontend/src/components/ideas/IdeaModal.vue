    ...
    >
      ...
      >
        <div>
          <div class="mb-2 flex flex-wrap items-center gap-2">
            ...
            <span
              :class="['rounded-full border px-2.5 py-0.5 text-xs font-semibold', priorityClass]"
            >
              {{ idea.priority }}
            </span>
            <span
          ...
          <p class="mt-1 text-sm text-gray-500">{{ idea.client }} · {{ idea.profile }}</p>
        </div>
        <Button
          variant="ghost"
          size="icon"
      ...
      <div class="flex flex-wrap justify-end gap-2 border-t border-gray-100 bg-gray-50 px-5 py-4">
        <Button
          ...
          size="sm"
          class="gap-2"
          @click="$emit('setStatus', idea.id, 'SAVED')"
        >
        ...
        <Button
          ...
          size="sm"
          class="gap-2"
          @click="$emit('setStatus', idea.id, 'DISMISSED')"
        >
